...
{% macro remove_deprecated_models() %}
    ...
    {% set models_to_drop = [
        ...
        ("mv", reporting, "most_recent_course_blocks"),
        ("mv", reporting, "fact_enrollment_status"),
        ("mv", reporting, "most_recent_object_tags"),
        ("mv", reporting, "most_recent_tags"),
        ("mv", reporting, "most_recent_taxonomies"),
        ...
        ("dictionary", reporting, "course_names"),
