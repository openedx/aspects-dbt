        ...
        insert into `xapi`.`dim_learner_first_success_response`
        ("org", "course_key", "object_id", "problem_id", "actor_id", "interaction_type", "attempt", "success", "responses", "scaled_score", "emission_time")
