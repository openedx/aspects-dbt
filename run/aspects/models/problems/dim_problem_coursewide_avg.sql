        ...
        insert into `xapi`.`dim_problem_coursewide_avg`
        ("org", "course_key", "course_order", "problem_link", "graded", "actor_id", "problem_id", "avg_correct_attempts_coursewide", "avg_incorrect_attempts_coursewide", "coursewide_percent_correct", "correct_attempts_by_learner", "incorrect_attempts_by_learner", "selected_learner_percent_correct", "selected_learner_percent_incorrect")
...
with
    last_response as (
        ...
        from `xapi`.`dim_learner_last_response`
    ),
