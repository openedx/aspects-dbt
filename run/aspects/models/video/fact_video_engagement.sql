        ...
        insert into `xapi`.`fact_video_engagement`
        ("org", "course_key", "section_subsection_name", "content_level", "actor_id", "section_subsection_video_engagement", "block_id", "username", "name", "email")
